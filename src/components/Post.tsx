...
function Post({ id, author, posted, image }: PostProps) {
    ...
    return (
        <div className="group/image transition duration-350 ease-in-out pb-4" id={id}>
            <div className="flex flex-shrink-0 pb-0">
                <div className="flex items-top bg-gray-50 group-hover/image:bg-gray-100 p-4 rounded-t-lg">
                    <div className="px-3">
                        <p className="items-center text-left text-base leading-6 font-medium text-gray-900">
                            {author}
                            <FontAwesomeIcon className="mx-3" icon={faUser} />
                            <span className="ml-1 text-sm leading-5 font-medium text-gray-700 group-hover:text-gray-300 transition ease-in-out duration-150">
                                Posted {new Date(posted).toDateString()}
                            </span>
                            <br />
                            <span className="text-xs leading-5 font-medium text-gray-500 group-hover:text-gray-300 transition ease-in-out duration-150">
                                ID: {id.toString()}
                            </span>
                        </p>
                    </div>
            ...
            <div className="">
                ...
                <div className="">
                    <div className="flex pt-10 px-7 bg-gray-50 group-hover/image:bg-gray-100 rounded-tr-lg transition-colors duration-300 peer/image">
                        <img
                ...
                <div className="flex justify-between">
                    <div className="w-full max-w-56 bg-gray-50 group-hover/image:bg-gray-100 px-3 py-2 rounded-b-lg xs:rounded-b-none xs:rounded-bl-lg">
                    ...
                    <div className="w-full h-auto max-w-72 bg-gray-50 group-hover/image:bg-gray-100 px-3 py-2 rounded-b-lg xs:rounded-b-none xs:rounded-br-lg">
