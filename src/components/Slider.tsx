...
const Slider: React.FC<SliderProps> = ({ size, setSize }) => {
    ...
    return (
        <div className="relative mb-6">
            <label htmlFor="labels-range-input" className=" text-left block mb-0 text-xs font-medium text-gray-900 dark:text-white">Node size</label>
            <input id="labels-range-input" type="range" min="12" max="22" value={size} step="3.33" onChange={(e) => handleSliderChange(e)} className="w-full h-1 mb-1 range-sm text-blue-500 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
