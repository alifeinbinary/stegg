...
const Slider: React.FC<SliderProps> = ({ size, setSize }) => {
    ...
    return (
        <div className="relative lg:w-60 md:w-40 sm:w-48 mb-6 mx-3">
            ...
            <input id="labels-range-input" tabIndex={0} type="range" min="12" max="22" value={size} step="3.33" onChange={(e) => handleSliderChange(e)} className="w-full h-1 mb-1 range-sm text-blue-900 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" />
